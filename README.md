...
- `khard` - a terminal-based address book. Pressing tab while typing an address to send mail to will suggest contacts that are in your khard.
...
- `a` to add address/person to khard and `Tab` while typing address to complete one from book.
